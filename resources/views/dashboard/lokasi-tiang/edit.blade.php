...
@section('title-header', 'Ubah Lokasi')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('lokasi-tiang.index') }}">Lokasi</a></li>
    <li class="breadcrumb-item active">Ubah Lokasi</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah Lokasi</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('lokasi-tiang.update', $lokasi_tiang->id) }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_box') is-invalid @enderror" id="nama_box"
                                        placeholder="Input Nama Box" value="{{ old('nama_box', $lokasi_tiang->nama_box) }}" name="nama_box">
                            ...
                            <div class="col-6">
                                ...
                                <label for="kode_pos">Kode Pos</label>
                                    <input type="text" class="form-control @error('kode_pos') is-invalid @enderror" id="kode_pos"
                                        placeholder="Input Kode Pos" value="{{ old('kode_pos', $lokasi_tiang->kode_pos) }}" name="kode_pos">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="provinsi_input" name="provinsi">
                                    ...
                                    @foreach ($provinsis as $provinsi)
                                        <option value="{{ $provinsi['id'] }}" {{ ($lokasi_tiang->provinsi == $provinsi['id']) ? 'selected' : '' }}>
                                             {{ $provinsi['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror"
                                        id="alamat" placeholder="Input Alamat Lengkap" name="alamat">{{ old('alamat', $lokasi_tiang->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="d-block invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
